    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div 
          ...
          className="absolute inset-0 w-full h-full bg-black/95 backdrop-blur-xl z-50 flex items-center justify-center cursor-crosshair overflow-hidden"
